...
CREATE TABLE `im_goods_brand` (
  ...
  `url` varchar(255) DEFAULT '#' COMMENT '连接地址',
  PRIMARY KEY (`id`)
...
CREATE TABLE `im_goods_info` (
  ...
  `url` varchar(255) DEFAULT '#' COMMENT 'URL连接地址',
  PRIMARY KEY (`id`)
